...
<style>
    ...
    <div class="row secHead my-5w-100 p-0 mx-0 mt-5">
        <div class="col-12 text-center subPage">
            <h2>Cancel Ticket Preview</h2>
        </div>
    </div>
<form id="ferryBookingForm" action="{{url('/ticket-cenceled-details-ferry')}}" method="POST">
    @csrf
    <div class="container ">
        <div class="row w-100 p-0 m-0 bg-white">
            <div class="px-2 col-12 py-1 tripDirection">
                <p class=" m-0 ">Date of Journey : <span class="departing-txt-date d-inline-block">{{ date('d-m-Y', strtotime($ferry_bookings[0]->date_of_jurney)) }}</span>
                ...
                <table class="w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="passenger_ids[]" id="" value="{{$booking->id}}" class="passenger-checkbox"></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-12 col-md-8 col-lg-4 bannerBtns text-center d-block">
                <button type="submit" id="confirmButton" class="btn m-auto bg-success text-white" style="width: 140px; height: 40px; ">Confirm</button>
            </div>
        </div>
    </div>
</form>
