...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p>At Andaman Ferry Ticket, accessible from <a
                        href="mailto:bookmyferry@gmail.com  ">bookmyferry@gmail.com</a>, one of our main
                    priorities is the privacy of our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by Andaman Ferry Ticket and how we use it.</p>
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                    website with regards to the information that they shared and/or collect in Andaman Ferry
                    Ticket. This policy is not applicable to any information collected offline or via channels
                ...
                <p>
                    Then you register for an Account, we may ask for your contact information, including items
                ...
                <p>Andaman Ferry Ticket follows a standard procedure of using log files. These files log
                ...
                <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
                    Andaman Ferry Ticket.</p>
                <p>
                    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                    Beacons that are used in their respective advertisements and links that appear on Andaman
                    Ferry Ticket, which are sent directly to users' browser. They automatically receive your IP
                ...
                <p>
                    Note that Andaman Ferry Ticket has no access to or control over these cookies that are used
                ...
                <p>
                    Andaman Ferry Ticket's Privacy Policy does not apply to other advertisers or websites. Thus,
                ...
                <p>Another part of our priority is adding protection for children while using the internet. We
                    ...
                    online activity.</p>
                <p>Andaman Ferry Ticket does not knowingly collect any Personal Identifiable Information from
