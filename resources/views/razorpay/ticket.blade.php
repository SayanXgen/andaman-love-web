        ...
        <div class="main-container" id="ticket">
            <div class="ticket-header">
                @if($single_booking->type == 'ferry')
                  <img src="{{ asset('asset/img/andaman.jpg') }}" alt="ticket-header" style="width:100%;">
                    ...
                    <div class="detail-table-main-form">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                            ...
                            <tr>
                                ...
                                @if ($single_booking->from_location == 1)
                                    <td class="highlight-text">Port Blair</td>
                                @elseif ($single_booking->from_location == 2)
                                    <td class="highlight-text">Havelock</td>
                                @else
                                    <td class="highlight-text">Neil</td>
                                @endif

                                @if ($single_booking->to_location == 1)
                                    <td class="highlight-text">Port Blair</td>
                                @elseif ($single_booking->to_location == 2)
                                    <td class="highlight-text">Havelock</td>
                                @else
                                    <td class="highlight-text">Neil</td>
                                @endif
                    ...
                    <div class="detail-table-main-form">
                        ...
                        <table width="100%;" border="0" align="center" cellpadding="5" cellspacing="0">
                            ...
                            <tr>
                                ...
                                @if ($trip2_booking_id->from_location == 1)
                                    <td class="highlight-text">Port Blair</td>
                                @elseif ($trip2_booking_id->from_location == 2)
                                    <td class="highlight-text">Havelock</td>
                                @else
                                    <td class="highlight-text">Neil</td>
                                @endif

                                @if ($trip2_booking_id->to_location == 1)
                                    <td class="highlight-text">Port Blair</td>
                                @elseif ($trip2_booking_id->to_location == 2)
                                    <td class="highlight-text">Havelock</td>
                                @else
                                    <td class="highlight-text">Neil</td>
                                @endif
                ...
                <div class="detail-table-main-form">
                    ...
                    <table width="100%;" border="0" align="center" cellpadding="5" cellspacing="0">
                        ...
                        <tr>
                            ...
                            @if ($trip3_booking_id->from_location == 1)
                                <td class="highlight-text">Port Blair</td>
                            @elseif ($trip3_booking_id->from_location == 2)
                                <td class="highlight-text">Havelock</td>
                            @else
                                <td class="highlight-text">Neil</td>
                            @endif

                            @if ($trip3_booking_id->to_location == 1)
                                <td class="highlight-text">Port Blair</td>
                            @elseif ($trip3_booking_id->to_location == 2)
                                <td class="highlight-text">Havelock</td>
                            @else
                                <td class="highlight-text">Neil</td>
                            @endif
